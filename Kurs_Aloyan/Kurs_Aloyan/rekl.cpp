...
void text(HDC hdc, int& text)
{
    ...
    DrawText(hdc, TEXT("Город Мышкино"), -1, &rect1, DT_NOCLIP);
	...
	DrawText(hdc, TEXT("В ногу со временем. \n У нас производят все самое новое \n Приезжайте к нам. \nМы будем вам рады!"), -1, &rect1, DT_NOCLIP);
	...
	DrawText(hdc, TEXT("Телефон: 8(954)495-35-35 \nГен.Дир. Агаси Алоян"), -1, &rect1, DT_NOCLIP);
