...
void text(HDC hdc, int& text)
{
    ...
    DrawText(hdc, TEXT("Институт нефти"), -1, &rect1, DT_NOCLIP);
	...
	DrawText(hdc, TEXT("Поступайте в наш институт. \nУ нас вы узнаете много общего \n Наши филлиалы находятся в нескольких городах по всему миру. \nМы будем вам рады!"), -1, &rect1, DT_NOCLIP);
	...
	DrawText(hdc, TEXT("Телефон: 8(800)555-35-35 \nГен.Дир. Создателев Дмитрий"), -1, &rect1, DT_NOCLIP);
