...
void textik(HDC hdc, int& text)
{
    ...
    DrawText(hdc, TEXT("Цветик семицветик"), -1, &rect1, DT_NOCLIP);
	...
	DrawText(hdc, TEXT("два листочка проебались. \n Однако нам поебать \nв мы все равно семицветик. \nприходите к нам!"), -1, &rect1, DT_NOCLIP);
	...
	DrawText(hdc, TEXT("Телефон: 8(495)555-55-55 \nГен.Дир. Домаев Алексей"), -1, &rect1, DT_NOCLIP);
